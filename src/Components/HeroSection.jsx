...
function HeroSection(props) {
  ...
  useEffect(() => {
    ...
    setType1(props.data.type1);
    setType2(props.data.type2);
    setHeight(props.data.height);
    setWeight(props.data.weight);
    setId(props.id);
    setDescription(props.data.pokedescription)
    setpokemonstype(props.pokemontypes)
          ...
          <div className='herosubcont'>
            <div className='hero-main'>
              ...
              <div className='main-pages main-description' style={{ width: currentactive === "btn1" ? "100%" : "0", opacity: currentactive === "btn1" ? "1" : "0" }} >
                ...
                {console.log(pokemontypes[type1])}
